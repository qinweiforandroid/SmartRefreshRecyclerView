...
abstract class SmartRefreshListComponent<T> constructor(
    ...
    init {
        ...
        smartRefresh.inject(SmartRefreshLayoutRecyclerView(mRecyclerView, mSmartRefreshLayout))
...
//                mInnerAdapter.notifyDataSetChanged()
    ...
    inner class ListAdapter : BaseListAdapter() {
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder {
            ...
            return this@SmartRefreshListComponent.onCreateViewHolder(parent, viewType)
        }
        ...
        override fun getItemViewType(position: Int): Int {
            ...
            return this@SmartRefreshListComponent.getItemViewType(position)
        }
